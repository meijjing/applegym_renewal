...
$s_male_flg = isset($_SESSION["s_male_flg"])? $_SESSION["s_male_flg"]:"";
...
<head>
  ...
  <link rel="stylesheet" href="../css/members_css/edit.css">
  ...
  <?php include "../header.php"; ?>
    ...
    <div class="edit_section cfixed">
      ...
      <div class="edit_pg">
        ...
        <p class="mem_nm">
          <span><?php echo $array["mem_nm"]; ?></span>님의 회원정보입니다.
        </p>


        <form class="edit_form" action="edit_ok.php" method="post" onsubmit="return form_check()">
          ...
          <fieldset>
            ...
            <p>
              ...
              <input type="datet" name="birth" id="birth" maxlength="8" autocomplete="off" autocapitalize="off"
            ...
            <p class="edit_btns">
              <button type="submit" class="edit_btn">정보수정</button>
              <!-- 클릭했을때 문서 체크 스크립트 실행 -->
              <button type="button" class="del_btn" onclick="del_mem()">회원탈퇴</button>
