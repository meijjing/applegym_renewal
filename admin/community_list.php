...
<head>
  ...
  <link href="../css/admin_css/community_list.css" rel="stylesheet">
...
<body>
  ...
  <?php include "admin_header.php"; ?>
    ...
    <section class="list_section">
      ...
      <h2 class="cfixed">커뮤니티 게시물 관리</h2>
    ...
    ?>
        ...
        <tbody>
          <tr>
            ...
            <td class="title">
              <a href="../board/community_read.php?idx=<?php echo $board['idx']; ?>">
            ...
            <td class="edit edit_btn"><a href="../board/community_edit.php?idx=<?php echo $board["idx"]; ?>">수정</a></td>
      ...
      <div class="wr_btn">
        <button type="button" onclick="location.href='../board/community_write.php';">게시물 쓰기</button>
      </div>
      ...
      <?php } else { ?>
        <a class="list_prev_btn" href="community_list.php?page=<?php echo ($page-1); ?>">이전</a>
      <?php }; ?>
...
?>
        ...
        <a class="num_btn" href="community_list.php?page=<?php echo $print_page; ?>"><?php echo $print_page; ?></a>
        ...
        if($page >= $total_page) { 
        ?>
          <a class="list_next_btn" href="community_list.php?page=<?php echo $total_page; ?>">다음</a>

        <?php } else { ?>
          <a class="list_next_btn" href="community_list.php?page=<?php echo ($page + 1); ?>">다음</a>
