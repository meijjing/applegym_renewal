...
<head>
  ...
  <link href="../css/admin_css/notice_list.css" rel="stylesheet">
    ...
    ?>
        ...
        <tbody>
          <tr>
            ...
            <td class="title">
              <a href="../board/notice_read.php?idx=<?php echo $board['idx']; ?>">
            ...
            <td class="edit edit_btn"><a href="../board/notice_edit.php?idx=<?php echo $board["idx"]; ?>">수정</a></td>
      ...
      <div class="wr_btn">
        <button type="button" onclick="location.href='../board/notice_write.php';">게시물 쓰기</button>
      </div>
...
?>
        ...
        if($page >= $total_page) { 
        ?>
          <a class="list_next_btn" href="notice_list.php?page=<?php echo $total_page; ?>">다음</a>

        <?php } else { ?>
          <a class="list_next_btn" href="notice_list.php?page=<?php echo ($page + 1); ?>">다음</a>
