  ...
  <div class="wrap">
    ...
    <div class="write_section cfixed">
      <h2>이벤트 게시물 수정하기</h2>
        ...
        <!-- 입력 폼 -->
        <form class="wr_form" action="event_edit_ok.php?idx=<?php echo $bno; ?>" method="post" enctype="multipart/form-data" onsubmit="return form_check()">
          ...
          <fieldset class="cfixed">
            ...
            <p class="file cfixed">
              ...
              <a href="event_upload/<?php echo $board['b_file'];?>" download><?php echo $board['b_file']; ?></a>
