...
$query = "SELECT * FROM event_board WHERE (title like '%{$search}%') or (content like '%{$search}%') ORDER BY idx desc";
    ...
    <section class="contents">
      ...
      <section class="event_section">
        ...
        <div class="event_table">
          ...
          /// paging : 쿼리 작성
          $sql = "SELECT * FROM event_board WHERE (title like '%{$search}%') or (content like '%{$search}%') ORDER BY idx desc limit $start, $list_num;";
