...
$query = "SELECT * FROM notice_board WHERE $category like '%{$search}%' ORDER BY idx desc";
  ...
  <?php include "../header.php"; ?>
    ...
    <section class="contents">
      ...
      <section class="notice_section">
        <h2>NOTICE & NEWS</h2>
        <p>애플짐 전 지점의 공지사항과 뉴스</p>

        <h3>
          <span>'<?php echo $keyword; ?>'</span> 에서 &nbsp;&nbsp; <span>'<?php echo $search; ?>'</span> 검색 결과
        </h3>
...
/// paging : 쿼리 작성
$sql = mq("select * from notice_board where $category like '%{$search}%' order by idx desc limit $start, $list_num;");
...
?>
          ...
          <tbody>
            <tr>
              ...
              <td class="title">
                ...
                <!-- 비밀글 이미지 -->
                <?php 
                $lockimg = "<img class=\"lock_img\" src=\"../images/lock.png\" alt=\"lock\" title=\"lock\" />";
                
                if ($board['lock_post'] == "Y") {
                ?>

                <a href="notice_ck_read.php?idx=<?php echo $board['idx']; ?>" class="lock_tit"><?php echo $board['title'], $lockimg ?>
                ...
                <?php
                  ...
                  $timenow = date("Y-m-d"); 
                    ...
                    if($boardtime == $timenow) {
                      $img = "<img class=\"new_img\" src=\"../images/new.png\" alt=\"new\" title=\"new\" style=\"width: 25px\"/>";
                    
                    } else {
                      $img = "";
                    }; ?>
                  
                      <a href="notice_read.php?idx=<?php echo $board['idx']; ?>">
        ...
        <button type="button" class="wr_btn" onclick="location.href='notice_write.php'">글쓰기</button>
      ...
      <?php } else { ?>
        <a class="list_prev_btn" href="notice.php?page=<?php echo ($page-1); ?>">이전</a>
      ...
      ?>
        ...
        <a class="num_btn" href="notice.php?page=<?php echo $print_page; ?>"><?php echo $print_page; ?></a>
        ...
        <?php } else { ?>
          ...
          <a class="list_next_btn" href="notice.php?page=<?php echo ($page + 1); ?>">다음</a>
