  ...
  <div class="wrap">
    ...
    <div class="write_section cfixed">
      <h2>공지사항 게시물 수정하기</h2>
        ...
        <!-- 입력 폼 -->
        <form class="wr_form" action="notice_edit_ok.php?idx=<?php echo $bno; ?>" method="post" enctype="multipart/form-data" onsubmit="return form_check()">

          <fieldset class="cfixed">
            <legend class="blind">공지사항 게시물 수정하기</legend>
            ...
            <p class="email cfixed">
              ...
              <input type="text" name="email" id="email" maxlength="100" autocomplete="off"
            ...
            <p class="title cfixed">
              ...
              <input type="text" name="title" id="title" maxlength="100" autocomplete="off" autocapitalize="off" value="<?php echo $board['title'] ?>">
            ...
            <p class="file cfixed">
              ...
              <a href="notice_upload/<?php echo $board['b_file'];?>" download><?php echo $board['b_file']; ?></a>
