    ...
    <section class="contents">
      ...
      <div class="write_section cfixed">
        <h2>커뮤니티 게시물 수정하기</h2>
          ...
          <!-- 입력 폼 -->
          <form class="wr_form" action="community_edit_ok.php?idx=<?php echo $bno; ?>" method="post" enctype="multipart/form-data" onsubmit="return form_check()">
            ...
            <fieldset class="cfixed">
              ...
              <p class="title cfixed">
                ...
                <input type="text" name="title" id="title" maxlength="100" autocomplete="off"
                  autocapitalize="off" value="<?php echo $board['title'] ?>">
              </p>

              <p class="file cfixed">
                <label for="file">첨부파일: </label>
                <a href="community_upload/<?php echo $board['b_file'];?>" download><?php echo $board['b_file']; ?></a>
