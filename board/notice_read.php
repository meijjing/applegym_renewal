...
// 조회 수 올리기 
$hit = mysqli_fetch_array(mq("select * from notice_board where idx ='$bno';"));
$hit = $hit['hit'] + 1;
...
<body>
  ...
  <?php include "../header.php"; ?>
    ...
    <section class="notice_read_section">
      ...
      <div class="notice_read">
        ...
        <div class="notice_desc">
          ...
          <p class="upload_file"> 
            <span>
              첨부파일 : <a href="notice_upload/<?php echo $b_file;?>" download><?php echo $b_file; ?></a>
            </span>
            <span>
              
              <img src="notice_upload/<?php echo $b_file; ?>" alt="file">
        ...
        <button type="button" class="edit_btn" onclick="location.href='notice_edit.php?idx=<?php echo $board['idx']; ?>'">수정</button>
    ...
    <!-- 게시글 삭제 모달창 -->
    <!-- <section id="notice_del_modal">
      <div class="del_modal_body">
        <h3>게시글 삭제하기</h3>

        <form action="../admin/notice_del_ok.php?idx=<?php echo $bno; ?>" method="post" onsubmit="return form_check()">
          <fieldset>
      ...
      <div class="reply_log">
        ...
        <div id="cm_edit_modal">
          <div class="edit_modal_body">
            ...
            <form action="notice_reply_edit_ok.php" method="post">
              <fieldset>
        ...
        <div id="cm_del_modal">
          <div class="del_modal_body">
            ...
            <form action="notice_reply_del_ok.php" method="post">
              <fieldset>
  ...
  <script type="text/javascript">
    ...
    //     $('#notice_del_modal').addClass('active');
    //   })
    //   $(".close_btn").click(function() {
    //     $(this).closest('#notice_del_modal').removeClass('active')
    //   });
    // });
