...
if ($auth_nm && $pwd && $title && $content) {
  ...
  $query = mq("INSERT INTO notice_board (auth_nm, email, pwd, title, content, b_file, wr_date, hit, lock_post, ip) VALUES ('$auth_nm', '$eamil', '$pwd', '$title', '$content', '$o_name', now(), 0, '$lock_post', '$REMOTE_ADDR');");
