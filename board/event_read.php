...
// 조회 수 올리기 
$hit = mysqli_fetch_array(mq("select * from event_board where idx ='$bno';"));
$hit = $hit['hit'] + 1;
$fet = mq("update event_board set hit = '$hit' where idx = '$bno';");
...
<head>
  ...
  <link rel="stylesheet" href="../css/board_css/notice_read.css">
...
<body>
  ...
  <?php include "../header.php"; ?>
    ...
    <section class="notice_read_section">
      ...
      <div class="notice_read">
        ...
        <div class="notice_desc">
          ...
          <p class="upload_file"> 
            <span>
              첨부파일 : <a href="evnet_upload/<?php echo $b_file;?>" download><?php echo $b_file; ?></a>
            </span>
            <span>
              
              <img src="event_upload/<?php echo $b_file; ?>" alt="file">
        ...
        <button type="button" class="list_btn" onclick="location.href='event.php'">목록</button>

        <?php if ($s_id == 'admin') { ?>

        <button type="button" class="edit_btn" onclick="location.href='event_edit.php?idx=<?php echo $board['idx']; ?>'">수정</button>
        <button type="button" class="del_btn" onclick="del_post(<?php echo $board['idx']; ?>)">삭제</button>

        <?php } else {} ?>

      </div><!-- notice_read -->
    </section><!-- notice_post_section -->
    ...
    <section class="cmnt_section">
      ...
      <!-- 댓글 입력 폼 -->
      <div class="cm_input">
        <form action="event_reply_ok.php?idx=<?php echo $bno; ?>" method="post" class="cm_input cfixed">
      ...
      <?php 
      $query = "select * from event_reply where con_num='$bno' order by idx desc;";
      ...
      <div class="reply_log">
        ...
        <div id="cm_edit_modal">
          <div class="edit_modal_body">
            ...
            <form action="event_reply_edit_ok.php" method="post">
              <fieldset>
        ...
        <div id="cm_del_modal">
          <div class="del_modal_body">
            ...
            <form action="event_reply_del_ok.php" method="post">
              <fieldset>
  ...
  <script type="text/javascript">
    ...
    function del_post(idx) {
      ...
      if (ck == true) {
        location.href = "event_del_ok.php?idx="+idx;
      };
    };
    ...
    //     $('#event_del_modal').addClass('active');
    //   })
    //   $(".close_btn").click(function() {
    //     $(this).closest('#event_del_modal').removeClass('active')
    //   });
    // });
